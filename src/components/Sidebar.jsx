...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-between bg-white border-b border-gray-200 px-4 py-3 z-20 shadow-sm relative">
        <div className="flex items-center">
          <span className="text-xl font-black text-blue-600 tracking-tight">
            CRM <span className="text-gray-900 font-light">Lite</span>
          </span>
        </div>
        {/* Hamburger button to open/close the mobile sidebar */}
        <button
          onClick={toggleSidebar}
          className="text-gray-600 hover:text-blue-600 focus:outline-none transition-colors p-1"
      ...
      */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-200 shadow-xl md:shadow-none transform transition-transform duration-300 ease-in-out flex flex-col
      ...
      >
        ...
        <div className="h-16 flex items-center px-6 border-b border-gray-100 hidden md:flex">
          <span className="text-2xl font-black text-blue-600 tracking-tight cursor-pointer">
            STARTUP CRM <span className="text-gray-900 font-light">Lite</span>
          </span>
        </div>
